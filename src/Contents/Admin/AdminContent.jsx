...
const AdminContent = () => {
  ...
  const fetchData = useCallback(async () => {
    if (myUser) {
      try {
        console.log(UserId);
        const response1 = await fifiAxios.get(
          `${artikelPageApi}?jumlah=5&status=proses&id_user=${UserId}`,
          {
            headers: {
        ...
        const response2 = await fifiAxios.get(
          `${artikelPageApi}?jumlah=5&status=pra-terima&id_user=${UserId}`,
          {
            headers: {
              "Content-Type": "application/json",
            },
        ...
        const response3 = await fifiAxios.get(
          `${artikelPageApi}?jumlah=5&status=diterima&id_user=${UserId}`,
          {
            headers: {
              "Content-Type": "application/json",
            },
  ...
  async function jumlahStatus(status) {
    const response = await fifiAxios.get(
      `${artikelPageApi}?status=${status}&id_user=${UserId}`,
      {
        headers: {
          "Content-Type": "application/json",
        },
